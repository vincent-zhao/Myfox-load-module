...
INSERT INTO test_host_list VALUES (1,1,0,0,'host1',NOW(),NOW(),'192.168.1.1',3306,'db_read','123456','db_write','123456');
INSERT INTO test_host_list VALUES (2,1,0,0,'host2',NOW(),NOW(),'192.168.1.2',3306,'db_read','123456','db_write','123456');

UPDATE test_host_list SET host_pos = INET_ATON(conn_host);
...
INSERT INTO test_table_list VALUES (1,NOW(),NOW(),2,5,1000,'0.20',1,0,'mirror','测试镜像表','','','');
INSERT INTO test_table_list VALUES (2,NOW(),NOW(),2,5,1000,'0.20',0,1,'numsplit','测试切分表','thedate,cid','','');
...
INSERT INTO test_table_route VALUES (1,NOW(),NOW(),'numsplit','thedate','','date',1);
INSERT INTO test_table_route VALUES (2,NOW(),NOW(),'numsplit','cid','','int',1);
...
INSERT INTO test_table_column VALUES (1,1,UNIX_TIMESTAMP(),UNIX_TIMESTAMP(),'mirror','cid','uint','10','0','类目ID');
INSERT INTO test_table_column VALUES (2,2,UNIX_TIMESTAMP(),UNIX_TIMESTAMP(),'mirror','cname','char','255','','类目名字');
INSERT INTO test_table_column VALUES (3,100,UNIX_TIMESTAMP(),UNIX_TIMESTAMP(),'mirror','autokid','autokid','10','0','自增键');
INSERT INTO test_table_column VALUES (4,5,UNIX_TIMESTAMP(),UNIX_TIMESTAMP(),'numsplit','char1','char','32','','');
INSERT INTO test_table_column VALUES (5,2,UNIX_TIMESTAMP(),UNIX_TIMESTAMP(),'numsplit','cid','uint','10','0','');
INSERT INTO test_table_column VALUES (6,3,UNIX_TIMESTAMP(),UNIX_TIMESTAMP(),'numsplit','num1','uint','10','0','');
INSERT INTO test_table_column VALUES (7,4,UNIX_TIMESTAMP(),UNIX_TIMESTAMP(),'numsplit','num2','float','20,14','0.00','');
INSERT INTO test_table_column VALUES (8,1,UNIX_TIMESTAMP(),UNIX_TIMESTAMP(),'numsplit','thedate','date','','0000-00-00','');
INSERT INTO test_table_column VALUES (9,100,UNIX_TIMESTAMP(),UNIX_TIMESTAMP(),'numsplit','autokid','autokid','10','0','');
...
INSERT INTO test_table_index VALUES (1,UNIX_TIMESTAMP(),UNIX_TIMESTAMP(),0,'numsplit','idx_cid','cid');
...
-- 路由表
DROP TABLE IF EXISTS test_route_info_0;
CREATE TABLE test_route_info_0 (
	autokid int(10) unsigned not null auto_increment,
	addtime int(10) unsigned not null default 0,
	modtime int(10) unsigned not null default 0,
...
CREATE TABLE test_route_info_1 LIKE test_route_info_0;
CREATE TABLE test_route_info_2 LIKE test_route_info_0;
CREATE TABLE test_route_info_3 LIKE test_route_info_0;
CREATE TABLE test_route_info_4 LIKE test_route_info_0;
CREATE TABLE test_route_info_5 LIKE test_route_info_0;
CREATE TABLE test_route_info_6 LIKE test_route_info_0;
CREATE TABLE test_route_info_7 LIKE test_route_info_0;
CREATE TABLE test_route_info_8 LIKE test_route_info_0;
CREATE TABLE test_route_info_9 LIKE test_route_info_0;
CREATE TABLE test_route_info_a LIKE test_route_info_0;
CREATE TABLE test_route_info_b LIKE test_route_info_0;
CREATE TABLE test_route_info_c LIKE test_route_info_0;
CREATE TABLE test_route_info_d LIKE test_route_info_0;
CREATE TABLE test_route_info_e LIKE test_route_info_0;
CREATE TABLE test_route_info_f LIKE test_route_info_0;
